...
async def milvus_text_search(
    ...
    try:
        ...
        return f"Unexpected text search error: {str(e)}"
...
async def milvus_vector_search(
    ...
    try:
        ...
        return f"Unexpected vector search error: {str(e)}"
...
async def milvus_hybrid_search(
    ...
    try:
        ...
        return f"Unexpected hybrid search error: {str(e)}"
...
async def milvus_create_collection(
    ...
    try:
        ...
        return f"Unexpected collection creation error: {str(e)}"
...
async def milvus_insert_data(
    ...
    try:
        ...
        return f"Data insertion error: {str(e)}"
    except Exception as e:
        return f"Unexpected data insertion error: {str(e)}"
...
async def milvus_delete_entities(
    ...
    try:
        ...
        return f"Entity deletion error: {str(e)}"
    except Exception as e:
        return f"Unexpected entity deletion error: {str(e)}"
...
async def milvus_load_collection(
    ...
    try:
        ...
        return f"Collection loading error: {str(e)}"
    except Exception as e:
        return f"Unexpected collection loading error: {str(e)}"
...
async def milvus_release_collection(collection_name: str, ctx: Context = None) -> str:
    ...
    try:
        ...
        return f"Collection release error: {str(e)}"
    except Exception as e:
        return f"Unexpected collection release error: {str(e)}"
...
async def milvus_use_database(db_name: str, ctx: Context = None) -> str:
    ...
    try:
        ...
        return f"Database switch error: {str(e)}"
    except Exception as e:
        return f"Unexpected database switch error: {str(e)}"
...
async def milvus_get_collection_info(collection_name: str, ctx: Context = None) -> str:
    ...
    try:
        ...
        info_str = json.dumps(collection_info, indent=2, cls=CustomJSONEncoder)
        return f"Collection information:\n{info_str}"
    except ValueError as e:
        return f"Collection info error: {str(e)}"
    except Exception as e:
        return f"Unexpected collection info error: {str(e)}"
